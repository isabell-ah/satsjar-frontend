...
const ChildLearningPage = () => {
  ...
  // Mock lessons data (same as EnhancedLearningHub)
      ...
      {!selectedLesson && !selectedGame && !currentQuiz ? (
          ...
          <CardContent className='p-6 space-y-4'>
            ...
            <div className='bg-gray-50 p-6 rounded-lg'>
              ...
              >
                {loading
                  ? 'Completing...'
                  : `Complete Lesson (+${selectedLesson.reward} sats)`}
              </Button>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader className='bg-gradient-to-r from-green-500 to-emerald-500 text-white'>
            ...
            <CardDescription className='text-white/80'>
              Difficulty: {selectedGame.difficulty} • Win up to{' '}
              {selectedGame.reward} sats
            </CardDescription>
          </CardHeader>
          <CardContent className='p-6 space-y-4'>
            ...
            <div className='bg-gray-50 p-6 rounded-lg text-center'>
              ...
              <div className='bg-gray-100 p-8 rounded-lg mb-4'>
                <p className='text-center italic mb-4'>
                  This is where the game would load. In a real app, this would
                  be an interactive game component.
                </p>
                <div className='text-6xl mb-4'>🎮</div>
                <p className='text-sm text-gray-600'>Game loading...</p>
              </div>
              ...
              <Button
                ...
                onClick={() => {
                  toast({
                    ...
                    description: `You earned ${selectedGame.reward} sats!`,
                  });
...
export default ChildLearningPage;
