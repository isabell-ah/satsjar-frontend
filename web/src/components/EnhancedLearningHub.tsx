...
const EnhancedLearningHub: React.FC<EnhancedLearningHubProps> = ({ onBack }) => {
  ...
  const lessons: Lesson[] = [
    {
      id: '1',
      title: 'What is Money?',
      description: 'Learn about the basics of money and why we use it in our everyday lives.',
      duration: '2 min',
      reward: 10,
      completed: true,
    ...
    },
    {
      ...
      description: 'Discover the importance of saving money for the future and how it helps you achieve your goals.',
      duration: '3 min',
      reward: 15,
      completed: true,
    ...
    },
    {
      ...
      description: 'Learn about Bitcoin and how it works as a special kind of digital money.',
      duration: '4 min',
      reward: 20,
      completed: false,
    ...
    },
    {
      id: '4',
      title: 'Setting Goals',
      description: 'Learn how to set and achieve your savings goals step by step.',
      duration: '2 min',
      reward: 10,
      completed: false,
    ...
    },
    {
      ...
      reward: 15,
      completed: false,
      thumbnail: 'https://placehold.co/200x120/FFE4E6/1e293b?text=Wise+Spending',
      ageRange: '7-12'
    }
  ];
  ...
  const handleAnswerQuestion = (answerIndex: number) => {
    ...
    if (currentQuiz && currentQuestion < currentQuiz.questions.length - 1) {
      ...
      const earnedReward = currentQuiz ? Math.round((percentScore / 100) * currentQuiz.reward) : 0;
      ...
      {!selectedLesson && !selectedGame && !currentQuiz ? (
        <div className="space-y-6">
          ...
          <Card className="bg-gradient-to-r from-purple-500 to-indigo-500 text-white">
            <CardContent className="p-4">
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="text-lg font-semibold">Learning Streak: {learningStreak} days 🔥</h3>
                  <p className="text-sm text-white/80">Keep learning daily to earn bonus sats!</p>
                </div>
          ...
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardDescription>
                Level {learningPath.currentLevel}: {learningPath.xp}/{learningPath.nextLevelAt} XP
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Progress value={(learningPath.xp / learningPath.nextLevelAt) * 100} className="h-2 mb-2" />
              <p className="text-sm text-muted-foreground">
                {learningPath.completedLessons}/{learningPath.totalLessons} lessons completed
              </p>
            </CardContent>
          </Card>
                    ...
                    {games.map((game) => (
                      ...
                      >
                        ...
                        <div className="p-4">
                          ...
                          <p className="text-sm text-gray-600 line-clamp-2 h-10">{game.description}</p>
                          <div className="flex items-center justify-between mt-2">
                            <Badge variant="outline" className="border-amber-500 text-amber-600">
                        ...
                        <div className="flex justify-between items-center">
                          <div>
                            ...
                            <p className="text-sm text-gray-600">
                              {quiz.questions.length} questions • Earn up to {quiz.reward} sats
                            </p>
                          </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <div className="bg-gray-100 p-4 rounded-lg mb-4">
                <p className="text-center italic">
                  This is where the lesson video would play. 
                  In a real app, this would be an interactive video or animation.
                </p>
        ...
        <Card>
          <CardHeader className="bg-gradient-to-r from-green-500 to-emerald-500 text-white">
            ...
            <CardDescription className="text-white/80">
              {selectedGame.difficulty} difficulty • Win {selectedGame.reward} sats
            </CardDescription>
          </CardHeader>
          <CardContent className="p-6">
            <Button 
            ...
            <div className="bg-gray-50 p-6 rounded-lg text-center">
              ...
              <p className="mb-8">
                {selectedGame.description}. This is where the interactive game would be displayed. 
                In a real app, this would be a fun and educational money game.
              </p>
              ...
              <div className="text-center space-y-6">
                <div 
                  className={`text-2xl font-bold ${
                    quizScore >= 70 ? 'text-green-500' : quizScore >= 40 ? 'text-amber-500' : 'text-red-500'
                  }`}
                >
                ...
                <div className="p-4 rounded-lg bg-gray-50">
                  <p className="mb-2">You answered {userAnswers.filter((answer, index) => 
                    answer === currentQuiz.questions[index].correctAnswer).length} out of {currentQuiz.questions.length} questions correctly.</p>
                  
                  <p className="text-lg font-medium">
                    You earned {Math.round((quizScore / 100) * currentQuiz.reward)} sats!
                  </p>
                </div>
              ...
              <div className="space-y-6">
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <div className="space-y-2">
                    {currentQuiz.questions[currentQuestion].answers.map((answer, index) => (
                      <Button
                        key={index}
                        variant="outline"
